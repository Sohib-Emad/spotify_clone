class AppImages {
  ...
  static const String intro_bg = '${basePath}intro_bg$format';
  static const String choose_theme_bg = '${basePath}choose_mode_bg$format';
  static const String auth_bg = '${basePath}auth_bg$format';
